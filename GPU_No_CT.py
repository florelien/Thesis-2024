...
train = pd.read_pickle("plank_dataset_tokenized_NO_7CT_train.pkl")
...
train_dataset = CustomTrainDataset(dataset_parts["train"])
...
model_name = "t5-dutch-simplify-noCT-CT7"
